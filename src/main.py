...
import json
from utils.util_adv import initiate_model, average_scores
from utils.basemodel import judge_answers_other, judge_answers
from utils.advocates_architectures.arch_builder import judge_multi_advocates_20, judge2advocates_modified2




os.environ['OPENAI_API_KEY'] = '"sk-aa"'
os.environ['TOGETHER_API_KEY'] = '78b'
